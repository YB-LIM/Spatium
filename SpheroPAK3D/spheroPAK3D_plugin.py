...
class SpheroPAK3D_plugin(AFXForm):
    ...
    def __init__(self, owner):
        ...
        self.cmd = AFXGuiCommand(mode=self, method='GeneratePBCell',
            objectName='SpheroPAK3D_Kernel', registerQuery=False)
        pickedDefault = ''
    ...
    def getFirstDialog(self):
        ...
        import spheroPAK3DDB
        return spheroPAK3DDB.SpheroPAK3DDB(self)
...
toolset.registerGuiMenuButton(
    buttonText='SpheroPAK3D', 
    object=SpheroPAK3D_plugin(toolset),
    messageId=AFXMode.ID_ACTIVATE,
    icon=None,
    kernelInitString='import SpheroPAK3D_Kernel',
