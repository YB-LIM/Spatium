"""
A Python script to generate random sphere-packed unit cell geometry in Abaqus/CAE
...
def GeneratePBCell(Is_Porous, L, L_mesh, r_avg, r_std, VoF_tar, min_distance, 
    ...
    # Get the number of spheres from your Sphere_array
    ...
    if Mode=='Uniaxial Tension': #Uniaxial Tension
        ...
        mdb.models['Model-1'].DisplacementBC(name='RP-4', createStepName='Step-1', 
            region=region, u1=Disp, u2=UNSET, u3=UNSET, ur1=0.0, ur2=0.0, ur3=0.0, 
            amplitude=UNSET, fixed=OFF, distributionType=UNIFORM, fieldName='', 
            localCsys=None)
