...
Periodic images of spheres are generated as well, thus, geometry is fully periodic <br>
However, free meshing is applied and the mesh is not periodic. Thus, surface elements with regular mesh is generated and tied with the cell surface to enforce the periodic boundary condition <br>
